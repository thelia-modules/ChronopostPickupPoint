...
{
    /** @var string */
    public const DOMAIN_NAME = 'chronopostpickuppoint';

    public const CHRONOPOST_CONFIRMATION_MESSAGE_NAME = 'chronopost_pickup_point_confirmation_message_name';

    public const CHRONOPOST_TAX_RULE_ID = 'chronopost_pickup_point_tax_rule_id';
     ...
     */
    public function setDeliveryType($code, $title, $langs): void
    {
     ...
     */
    public function getDeliveryType(Request|Session $request): ?string
    {
        $deliveryMode = $request instanceof Request
            ? ($request->request->get('deliveryModuleOptionCode') ?? $request->query->get('deliveryModuleOptionCode') ?? '')
            : ($request->get('deliveryModuleOptionCode') ?? '');
     ...
     * @throws \Exception
     */
    public static function getPostageAmount($areaId, $weight, $cartAmount = 0, $deliveryCode = null): float
    {
     ...
     */
    public function getAllAreasForCountry(Country $country): array
    {
        $areaArray = [];
    ...
    public static function configureServices(ServicesConfigurator $servicesConfigurator): void
    {
        $servicesConfigurator->load(self::getModuleCode().'\\', __DIR__)
            ->exclude([
                ...
                __DIR__.'/Config/**/*.php',
                __DIR__.'/Model/*',
                __DIR__.'/ChronopostPickupPoint.php',
            ])
            ->autowire(true)
            ->autoconfigure(true);
    }
